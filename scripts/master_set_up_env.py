...
def main(args):
    ...
    os.system(f"mamba create -c bioconda -c conda-forge -p {os.path.join(args['conda_env_dir'], 'ViWrap-CheckV')} python=3.8 checkv diamond hmmer prodigal -y >/dev/null 2>&1")
    ...
    os.system(f"mamba create -c bioconda -c conda-forge -p {os.path.join(args['conda_env_dir'], 'ViWrap-dRep')} python=3 drep mash mummer -y >/dev/null 2>&1")
    ...
    os.system(f"mamba create-c bioconda -c conda-forge -p {os.path.join(args['conda_env_dir'], 'ViWrap-Mapping')} python=3.8 pysam bowtie2==2.4.5 coverm pandas pyfastx minimap2 consent -y >/dev/null 2>&1")   
    ...
    os.system(f"mamba create -c hcc -c conda-forge -p {os.path.join(args['conda_env_dir'], 'ViWrap-DVF')} -c hcc deepvirfinder -y >/dev/null 2>&1")   
